...
\renewcommand{\@noticestring}{
  \centering
  Preprint. Under preparation for ATTRIB 2026 (workshop, non-archival).
}
\makeatother
...
\begin{abstract}
% =====================================================================
% PLACEHOLDER — abstract deliberately HELD until the 8-seed matrix on the
% locked test battery is labeled (user decision). Draft variants exist in
% conversation record; final numbers slot into sentences 4–5.
% =====================================================================
[Abstract pending final matrix results.]
\end{abstract}
